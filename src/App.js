...
export default function App() {
  const [contacts, setContacts] = useState([
    { id: 'id-1', name: 'Rosie Simpson', number: '+79274591256' },
    { id: 'id-2', name: 'Hermione Kline', number: '+792174438912' },
    { id: 'id-3', name: 'Eden Clements', number: '+79676451779' },
    { id: 'id-4', name: 'Annie Copeland', number: '+7967275126' }
  ]);
